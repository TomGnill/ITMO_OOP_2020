    ...
    class Tests
    {
        ...
        public static void bomj()
        {
           ...
           testList1.Add("можно купить \"Ягоды\", на сумму:40, в количестве: 2");
            ...
            var res1 = MenusFitues.Bomj(02, 50);
            ...
            var res2 = MenusFitues.Bomj(03, 90);
        ...
        public static void ListBuyHelp()
        {
            ...
            var res1 = MenusFitues.ListBuyHelp(testShopping1);
            ...
            var res2 = MenusFitues.ListBuyHelp(testShopping2);
